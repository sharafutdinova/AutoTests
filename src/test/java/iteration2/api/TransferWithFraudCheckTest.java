...
public class TransferWithFraudCheckTest extends BaseTest {
  ...
  public void testTransferRiskFraudCheckWithSuccessStatus() {
    ...
    TransferResponseForFraud transferResponse =
        userSteps1.transferWithFraudCheck(
            senderAccount.getId(), receiverAccount.getId(), transferAmount);
    ...
    TransferResponseForFraud expectedResponse =
        TransferResponseForFraud.builder()
            .status("APPROVED")
  ...
  public void testTransferWithFraudCheckWithServerError() {
    ...
    softly.assertThat(transferResponse).isNotNull();
    String fraudReason =
        "Unexpected error during fraud check: 500 Server Error: \"{<EOL>  \"status\": \"ERROR\",<EOL>  \"decision\": \"ERROR\",<EOL>  \"riskScore\": \"0\",<EOL>  \"reason\": \"undefined\",<EOL>  \"requiresManualReview\": false,<EOL>  \"additionalVerificationRequired\": false<EOL>}\"";
    TransferResponseForFraud expectedResponse =
        TransferResponseForFraud.builder()
            .status("MANUAL_REVIEW_REQUIRED")
            .message("Transfer requires manual review")
  ...
  public void testTransferWithFraudCheckWithBadRequest() {
    ...
    softly.assertThat(transferResponse).isNotNull();
    String fraudReason =
        "Unexpected error during fraud check: 400 Bad Request: \"{<EOL>  \"status\": \"ERROR\",<EOL>  \"decision\": \"ERROR\",<EOL>  \"riskScore\": \"0\",<EOL>  \"reason\": \"undefined\",<EOL>  \"requiresManualReview\": false,<EOL>  \"additionalVerificationRequired\": false<EOL>}\"";
    TransferResponseForFraud expectedResponse =
        TransferResponseForFraud.builder()
            .status("MANUAL_REVIEW_REQUIRED")
            .message("Transfer requires manual review")
