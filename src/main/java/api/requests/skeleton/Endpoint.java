...
public enum Endpoint {
  ...
  DEPOSIT_WITH_FRAUD(
      "/accounts/deposit", DepositRequestForFraud.class, DepositResponseForFraud.class),
  TRANSFER_WITH_FRAUD_CHECK(
      "/accounts/transfer-with-fraud-check", TransferRequest.class, TransferResponseForFraud.class),
  FRAUD_CHECK_STATUS(
